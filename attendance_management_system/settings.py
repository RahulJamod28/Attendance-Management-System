...
INSTALLED_APPS = [
    ...
    'attendance_management_system', # Main app
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'attendance_management_system' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'attendance_management_system' / 'static',
]
...
# Auth User Model
AUTH_USER_MODEL = 'attendance_management_system.User'
